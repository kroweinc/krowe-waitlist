        ...
        <>
            ...
            <div className="bg-secondary/80 rounded-xl p-4 border border-border/60">
                ...
                <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="flex shrink-0 items-center gap-1.5 text-[10px] font-bold text-primary">
...
export function OperatorStepAvatar() {
    return (
        <span
            className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/15 text-[10px] font-bold text-primary"
            aria-hidden
        >
            You
        </span>
