  ...
  return (
    <section id="benefits" className="w-full page-surface py-20 sm:py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 sm:mb-12 text-center md:mb-16">
          <span className="mb-4 inline-block text-sm md:text-base font-extrabold uppercase tracking-[0.25em] text-primary">
            Why Krowe
          </span>
          <h2 className="mb-4 font-serif text-3xl sm:text-4xl tracking-tight text-balance text-foreground leading-[1.1] md:text-6xl">
